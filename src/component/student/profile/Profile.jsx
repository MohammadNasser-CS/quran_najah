...
export default function Profile(props) {
  ...
  let [studentStutas, setStudentStutas] = useState({});
  useEffect(() => {
    if(props==null){
        return;
    }
...
async function getStudentStatus() {
    userId['student_id']=props.user;
    console.log(userId);
    let { data } = await axios.post('http://localhost/multaqa/api/student_profile.php',userId);
    console.log(data);
    setStudentStutas(data.Student_profile);
}
  return (
        ...
        <div className={style.card_deck + " row grid gap-3 d-flex justify-content-center "}>
          <div className={style.box_shadow + " text-white d-flex mb-5 col-3 card"}>
            ...
            <div className="card-body">
              <h1 className=" card-title pricing-card-title">{studentStutas.no_of_save_pages} / 604</h1>
          ...
          <div className={style.box_shadow + "  text-white card mb-5 d-flex col-3"}>
            <div className="card-header">
              <h4 className="my-0 font-weight-normal">محصلة المراجعة</h4>
            </div>
            <div className="card-body">
              <h1 className="card-title pricing-card-title">{studentStutas.no_of_review_pages}</h1>
          ...
          <div className={style.box_shadow + "  text-white card mb-5 d-flex col-3 ="}>
            ...
            <div className="card-body">
              <h1 className="card-title pricing-card-title">{studentStutas.no_of_exam_completed}</h1>
              <ul className="list-unstyled mt-3 mb-4">
                <p className='fw-bold'>
